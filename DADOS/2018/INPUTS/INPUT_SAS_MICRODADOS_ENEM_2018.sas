...
/*------------------------------------------------------------------------*/
/*  DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENEM DE 2018       */    
/*                                                                        */
/**************************************************************************/
/**************************************************************************/
/* Obs:                                                                   */
...
/* MICRODADOS_ENEM_2018.CSV no diretório C:\ do computador.			      */
/*															 			  */                                           
...
DATA WORK.DADOS_ENEM_2018;
INFILE 'C:\MICRODADOS_ENEM_2018.csv'  /*local do arquivo*/
        LRECL=963
        FIRSTOBS=2
        DLM=';'
        MISSOVER
