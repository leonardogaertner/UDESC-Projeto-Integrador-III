...
#     ITENS_PROVA_ENEM_2018.csv no diretório raiz. 
#     Ex. Windows C:\
#         Linux \home	                  
#------------------------------------------------------------------------
...
#itens_2018$SG_AREA <- factor(itens_2018$SG_AREA, levels = c('CH','CN','LC','MT'),  labels=c('Ciências Humanas','Ciências da Natureza','Linguagens e Códigos','Matemática'))
...
#itens_2018$IN_ITEM_ABAN <- factor(itens_2018$IN_ITEM_ABAN, levels = c(1,0),  labels=c('Sim','não'))
