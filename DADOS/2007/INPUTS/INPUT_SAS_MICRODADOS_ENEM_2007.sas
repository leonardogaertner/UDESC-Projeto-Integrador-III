...
/*------------------------------------------------------------------------*/
/*  PROGRAMA:                                                             */
/*           INPUT_SAS_MICRODADOS_ENEM_2007.sas                        	  */
/*------------------------------------------------------------------------*/
/*  DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENEM DE 2007       */    
/*                                                                        */
/**************************************************************************/
/**************************************************************************/
/* Obs:                                                                   */
...
/* MICRODADOS_ENEM_2007.CSV no diretório C:\ do computador.			      */
/*															 			  */                                           
...
proc format;
	...
	value  $Qvintedois
		...
		K='Outra situação';
	value  $Qvintetres
		A='Até 1 salário mínimo (até R$ 380,00 inclusive)'
...
DATA WORK.DADOS_ENEM_2007;
INFILE 'C:\MICRODADOS_ENEM_2007.csv' /*local do arquivo*/
        LRECL=1597
        FIRSTOBS=2
        DLM=';'
        MISSOVER
...
LABEL
NU_INSCRICAO = 'Número de inscrição no ENEM 2007.'
NU_ANO = 'Ano do Enem'
