...
/*----------------------------------------------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                                                      */
/*           INPUT_SPSS_MICRODADOS_ENEM_2008                                                  */
/*----------------------------------------------------------------------------------------------------------------------------*/
...
GET DATA
  /TYPE=TXT
  /FILE="C:\MICRODADOS_ENEM_2008.csv" /*local do arquivo*/
  /DELCASE=LINE
  /DELIMITERS=";"
...
CACHE.
EXECUTE.
DATASET NAME ENEM_08 WINDOW=FRONT.
...
CO_UF_PROVA   " Código da Unidade da Federação da PROVA em que o inscrito fez a prova"
SG_UF_PROVA   " Sigla da Unidade da Federação da PROVA em que o inscrito fez a prova"
