...
/*----------------------------------------------------------------------------------------------------------------------------*/
/*  PROGRAMA:                                                                                                      */
/*           INPUT_SPSS_MICRODADOS_ENEM_2013                                                 */
/*----------------------------------------------------------------------------------------------------------------------------*/
...
/* CONSISTENCIA_CENSO_2013 no diretório C:\ do computador.	                  */
/*							 */ 
/*							 */
...
GET DATA
  /TYPE=TXT
  /FILE="C:\MICRODADOS_ENEM_2013.csv"
  /DELCASE=LINE
  /DELIMITERS=";"
...
CACHE.
EXECUTE.
DATASET NAME DADOS_ENEM_2011 WINDOW=FRONT.
