...
itens_2011 <- data.table::fread(input='itens_prova_2011.csv',integer64='character')
...
#itens_2011$SG_AREA <- factor(itens_2011$SG_AREA, levels = c('CH','CN','LC','MT'),  labels=c('Ciências Humanas','Ciências da Natureza','Linguagens e Códigos','Matemática'))
#itens_2011$TP_LINGUA <- factor(itens_2011$TP_LINGUA, levels = c(0,1),  labels=c('Inglês','Espanhol'))
#itens_2011$IN_ITEM_ABAN <- factor(itens_2011$IN_ITEM_ABAN, levels = c(1,0),  labels=c('Sim','Não'))
