...
/*------------------------------------------------------------------------*/
/*  PROGRAMA:                                                             */
/*           INPUT_SAS_MICRODADOS_ENEM_2005.sas                        	  */
/*------------------------------------------------------------------------*/
/*  DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENEM DE 2005       */    
/*                                                                        */
/**************************************************************************/
/**************************************************************************/
/* Obs:                                                                   */
...
/* MICRODADOS_ENEM_2005.CSV no diretório C:\ do computador.			      */
/*															 			  */                                           
...
proc format;
	...
	value  $Qsetentaquatro
		A='Vai concluir após 2005'
		B='Vai concluir no segundo semestre de 2005'
		C='No primeiro semestre de 2005'
		D='Em 2004'
		E='Em 2003'
		F='Em 2002'
		G='Em 2001'
...
DATA WORK.DADOS_ENEM_2005;
INFILE 'C:\MICRODADOS_ENEM_2005.csv' /*local do arquivo*/
        LRECL=1540
        FIRSTOBS=2
        DLM=';'
        MISSOVER
...
LABEL
NU_INSCRICAO = 'Número de inscrição no ENEM 2005.'
NU_ANO = 'Ano do Enem'
