...
/*------------------------------------------------------------------------*/
/*  DESCRICAO: PROGRAMA PARA LEITURA DOS MICRODADOS DO ENEM DE 2017       */    
/*                                                                        */
/**************************************************************************/
/**************************************************************************/
/* Obs:                                                                   */
...
DATA WORK.DADOS_ENEM_2017;
INFILE 'C:\MICRODADOS_ENEM_2017.csv' /*local do arquivo*/
        LRECL=963
        FIRSTOBS=2
        DLM=';'
        MISSOVER
...
ATTRIB TP_ENSINO 					FORMAT=$TP_ENSINO43.;
